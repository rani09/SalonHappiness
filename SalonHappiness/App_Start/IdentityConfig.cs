...
namespace SalonHappiness
{
    ...
    public class ApplicationUserManager : UserManager<User>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<User>(context.Get<SalonDbContext>()));
