...
namespace SalonHappiness.ASPSMSX2 {
    ...
    public interface ASPSMSX2Soap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        SalonHappiness.ASPSMSX2.vouchers[] GetVoucherTransactions(string UserKey, string Password);
        
        [System.ServiceModel.OperationContractAttribute(Action="https://webservice.aspsms.com/aspsmsx2.asmx/GetVoucherTransactions", ReplyAction="*")]
        System.Threading.Tasks.Task<SalonHappiness.ASPSMSX2.vouchers[]> GetVoucherTransactionsAsync(string UserKey, string Password);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ASPSMSX2SoapChannel : SalonHappiness.ASPSMSX2.ASPSMSX2Soap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ASPSMSX2SoapClient : System.ServiceModel.ClientBase<SalonHappiness.ASPSMSX2.ASPSMSX2Soap>, SalonHappiness.ASPSMSX2.ASPSMSX2Soap {
        ...
        public SalonHappiness.ASPSMSX2.vouchers[] GetVoucherTransactions(string UserKey, string Password) {
            return base.Channel.GetVoucherTransactions(UserKey, Password);
        }
        
        public System.Threading.Tasks.Task<SalonHappiness.ASPSMSX2.vouchers[]> GetVoucherTransactionsAsync(string UserKey, string Password) {
